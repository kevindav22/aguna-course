        ...
        <div className="relative ml-40 w-full">
          ...
          <div className="flex gap-5 mt-14">
            ...
            <Button variant="ghost">
              Watch Video <Image src="/images/icon-play-video.svg" alt="play-video" width={29} height={29} />
            </Button>
          </div>
        </div>
        <Image src="/images/img-hero.png" alt="hero sporton" width={700} height={950} className="absolute -right-5 top-1/2 -translate-y-1/2" />
      </div>
      <Image src="/images/img-ornament-hero.svg" alt="ornament sporton" width={420} height={420} className="absolute  -right-50 top-1/2 -translate-y-1/2" />
    </section>
  );
};
