    ...
    <section id="category-section" className="container mx-auto py-16">
      ...
      <div className="grid grid-cols-6 gap-12 mt-8">
        {categories.map((category) => (
          <div key={category._id} className="flex justify-center rounded-lg bg-gradient-to-r from-[#F1F1F1] to-[#F7F7F7] w-full aspect-square">
            <div className="self-center">
              <Image src={getImageUrl(category.imageUrl)} width={86} height={86} alt={category.name} />
