    ...
    <Modal isOpen={isOpen} onClose={onClose} title={isEditMode ? 'Edit Product' : 'Add New Product'}>
      <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4 w-full">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="input-group-admin">
                ...
                <input type="number" id="price" name="price" value={formData.price} onChange={handleChange} placeholder="e. g. 500000" />
              </div>
              <div className="input-group-admin">
        ...
        <div className="input-group-admin">
          ...
          <textarea name="desciption" id="description" value={formData.description} onChange={handleChange} rows={7} placeholder="Product Detail......"></textarea>
        </div>
        <Button type="submit" className="ml-auto mt-3 rounded-lg" onClick={handleSubmit} disabled={isSubmitting}>
